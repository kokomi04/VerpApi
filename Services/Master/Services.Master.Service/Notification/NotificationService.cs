...
namespace VErp.Services.Master.Service.Notification
{
    ...
    public class NotificationService : INotificationService
    {
        ...
        public NotificationService(MasterDBContext masterDBContext, IMapper mapper, IActivityLogService activityLogService)
        {
        ...
        {
            var query = _masterDBContext.Notification.Where(x => userId == x.UserId && x.IsRead == false);
        ...
        {
            var querySub = _masterDBContext.Subscription.Where(x => x.ObjectId == model.ObjectId && x.ObjectTypeId == model.ObjectTypeId);
            ...
            _masterDBContext.Notification.AddRange(lsNewNotification);
