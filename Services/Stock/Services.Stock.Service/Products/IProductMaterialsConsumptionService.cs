...
namespace VErp.Services.Stock.Service.Products
{
    ...
    {
        Task<bool> UpdateProductMaterialsConsumptionService(int productId, ICollection<ProductMaterialsConsumptionModel> model);
        Task<IEnumerable<ProductMaterialsConsumptionModel>> GetProductMaterialsConsumptionService(int productId);
