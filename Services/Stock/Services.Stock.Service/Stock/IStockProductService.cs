...

{
    public interface IStockProductService
    {
        ...
        Task<PageData<StockProductQuantityWarning>> GetStockProductQuantityWarning(string keyword, IList<int> stockIds, IList<int> productTypeIds, IList<int> productCateIds, IList<int> rangeQuantityRemaining, bool? isMinOrMax, string sortBy, bool asc, int page, int size, Clause filters);
