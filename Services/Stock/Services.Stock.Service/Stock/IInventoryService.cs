...
namespace VErp.Services.Stock.Service.Stock
{
    ...
    public interface IInventoryService
    {
        ...
        Task<PageData<ProductPackageOutputModel>> GetProductPackageListForExport(string keyword, bool? isTwoUnit, IList<long> packageIds, IList<int> stockIds, int page = 1, int size = 20);
