...
namespace VErp.Services.Stock.Service.Stock.Implement
{
    public partial class InventoryBillInputService : InventoryServiceAbstract, IInventoryBillInputService
    {
        ...
        {
            ProductSearchRequestModel req = new ProductSearchRequestModel(keyword, new int[0], "", new int[0], productCateIds.ToArray(), page, size, null, null, null);
            //var productList = await _productService.GetList(keyword, new int[0], "", new int[0], productCateIds, page, size, null, null, null);
            var productList = await _productService.GetList(req);
