...
namespace VErp.Services.Organization.Service.Department
{
    public interface IDepartmentService
    {
        ...
        Task<PageData<DepartmentModel>> GetList(string keyword, IList<int> departmentIds, bool? isProduction, bool? isActived, int page, int size, string orderByFieldName, bool asc, Clause filters = null);
