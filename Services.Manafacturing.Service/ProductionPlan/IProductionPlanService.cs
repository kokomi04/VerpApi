...
namespace VErp.Services.Manafacturing.Service.ProductionPlan
{
    ...
    {
        Task<IList<ProductionOrderListModel>> GetProductionPlans(int? monthPlanId, long startDate, long endDate);
        Task<IDictionary<long, List<ProductionWeekPlanModel>>> GetProductionPlan(int? monthPlanId, long startDate, long endDate);
        ...
        Task<(Stream stream, string fileName, string contentType)> ProductionPlanExport(int? monthPlanId, long startDate, long endDate, ProductionPlanExportModel data, IList<string> mappingFunctionKeys = null);

        Task<IDictionary<long, WorkloadPlanModel>> GetWorkloadPlan(IList<long> productionOrderIds);
        Task<IDictionary<long, WorkloadPlanModel>> GetWorkloadPlanByDate(int? monthPlanId, long startDate, long endDate);
