...
using MigrateOldClauseIdToFieldName.Services;
...
namespace MigrateOldClauseIdToFieldName
{
    public class AppStartup : BaseStartup
    {
        ...
        {
            services.AddScoped<IMigrateOldClauseIdToFieldNameService, MigrateOldClauseIdToFieldNameService>();
        }
    }
}
