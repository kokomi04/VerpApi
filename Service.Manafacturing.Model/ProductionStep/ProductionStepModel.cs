...
namespace VErp.Services.Manafacturing.Model.ProductionStep
{
    public class ProductionStepModel : IMapFrom<ProductionStepEntity>
    {
        ...
        public EnumProductionOrderAssignmentStatus ProductionStepAssignmentStatusId { get; set; }
        public void Mapping(Profile profile)
        {
            profile.CreateMapCustom<ProductionStepEntity, ProductionStepModel>()
                ...
                .ForMember(m => m.HandoverTypeId, a => a.MapFrom(s => s.StepId.HasValue ? (EnumHandoverTypeStatus)s.Step.HandoverTypeId : EnumHandoverTypeStatus.Push))
