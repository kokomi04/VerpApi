...
namespace VErpApi.Controllers.PurchaseOrder
{
    ...
    public class PurchasingRequestController : VErpBaseController
    {
        ...
        {
            return await _purchasingRequestService.GetList(keyword, productIds, purchasingRequestStatusId, poProcessStatusId, isApproved, fromDate, toDate, sortBy, asc, page, size);
        }
        ...
        public async Task<ServiceResult> UpdatePoProcessStatus([FromRoute] long purchasingRequestId, [FromBody] EnumPoProcessStatus poProcessStatusId)
        {
