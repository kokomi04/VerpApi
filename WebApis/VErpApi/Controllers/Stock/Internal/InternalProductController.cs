...
namespace VErpApi.Controllers.Stock.Internal
{
    ...
    public class InternalProductController : CrossServiceBaseController
    {
        ...
        [Route("")]
        public async Task<PageData<ProductListOutput>> Search([FromBody] Clause filters, [FromQuery] string keyword, [FromQuery] string productName, [FromQuery] int page, [FromQuery] int size, [FromQuery] int[] productTypeIds = null, [FromQuery] int[] productCateIds = null, [FromQuery] bool? isProductSemi = null)
        {
            return await _productService.GetList(keyword, productName, productTypeIds, productCateIds, page, size, isProductSemi, filters);
        }
