...
namespace VErpApi.Controllers.Stock.Stocks
{
    ...
    public class LocationController : VErpBaseController
    {
        ...
        [HttpPost]
        [Route("")]
        public async Task<int> AddLocation([FromBody] LocationInput location)
        {
        ...
        [HttpGet]
        [Route("{locationId}")]
        public async Task<LocationOutput> GetLocation([FromRoute] int locationId)
        {
        ...
        [HttpPut]
        [Route("{locationId}")]
        public async Task<bool> UpdateLocation([FromRoute] int locationId, [FromBody] LocationInput location)
        {
        ...
        [HttpDelete]
        [Route("{locationId}")]
        public async Task<bool> Delete([FromRoute] int locationId)
        {
