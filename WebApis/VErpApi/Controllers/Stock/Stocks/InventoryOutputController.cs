...
namespace VErpApi.Controllers.Stock.Inventory
{
    ...
    public class InventoryOutputController : VErpBaseController
    {
            ...
            [FromBody] Clause filters = null)
        {
            ...
            return await _inventoryService.GetListDetails(keyword, customerId, productIds, stockId, inventoryStatusId, EnumInventoryType.Output, beginTime, endTime, isInputBillCreated, sortBy, asc, page, size, inventoryActionId, filters).ConfigureAwait(true);
        }
