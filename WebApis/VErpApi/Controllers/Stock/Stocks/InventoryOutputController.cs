...
{
    [Route("api/inventoryOutput")]
    public class InventoryOutputController : VErpBaseController
    {
        private readonly IInventoryService _inventoryService;

        public InventoryOutputController(
            ...
            [FromBody] Clause filters = null)
        {
            ...
            return await _inventoryService.GetListByProduct(keyword, customerId, productIds, stockId, inventoryStatusId, EnumInventoryType.Output, beginTime, endTime, isInputBillCreated, sortBy, asc, page, size, inventoryActionId, filters).ConfigureAwait(true);
        }
        ...
        {
            return await _inventoryService.GetInfosByIds(inventoryIds, EnumInventoryType.Output);
        }
