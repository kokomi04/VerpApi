...
namespace VErpApi.Controllers.Stock.Stocks
{
    ...
    public class StockController : VErpBaseController
    {
        ...
        [HttpGet]
        [Route("GetAll")]
        public async Task<ServiceResult<PageData<StockOutput>>> GetAll([FromQuery] string keyword, [FromQuery] int page, [FromQuery] int size)
        {
        ...
        [HttpGet]
        [Route("")]
        public async Task<ServiceResult<PageData<StockOutput>>> Get([FromQuery] string keyword, [FromQuery] int page, [FromQuery] int size)
        {
        ...
        public async Task<ServiceResult<PageData<StockOutput>>> GetListByUserId([FromQuery] string keyword, [FromQuery] int page, [FromQuery] int size)
        {
        ...
        [HttpGet]
        [Route("SimpleList")]
        public async Task<ServiceResult<IList<SimpleStockInfo>>> SimpleList()
        {
        ...
        [HttpPost]
        [Route("")]
        public async Task<ServiceResult<int>> AddStocks([FromBody] StockModel stock)
        {
        ...
        [HttpPut]
        [Route("{stockId}")]
        public async Task<ServiceResult> UpdateStock([FromRoute] int stockId, [FromBody] StockModel stock)
        {
        ...
        [HttpDelete]
        [Route("{stockId}")]
        public async Task<ServiceResult> Delete([FromRoute] int stockId)
        {
        ...
        [HttpGet]
        [Route("StockWarnings")]
        public async Task<ServiceResult<IList<StockWarning>>> StockWarnings()
        {
        ...
        public async Task<ServiceResult<PageData<StockProductListOutput>>> StockProducts([FromRoute] int stockId, [FromQuery] string keyword, [FromQuery] IList<int> productTypeIds, [FromQuery] IList<int> productCateIds, [FromQuery] IList<EnumWarningType> stockWarningTypeIds, [FromQuery] int page, [FromQuery] int size)
        {
        ...
        public async Task<ServiceResult<PageData<StockProductPackageDetail>>> StockProductPackageDetails([FromRoute] int stockId, [FromRoute] int productId, [FromQuery] int page, [FromQuery] int size)
        {
        ...
        public async Task<ServiceResult<PageData<LocationProductPackageOuput>>> LocationProductPackageDetails([FromRoute] int stockId, [FromQuery] int? locationId, [FromQuery] IList<int> productTypeIds, [FromQuery] IList<int> productCateIds, [FromQuery] int page, [FromQuery] int size)
        {
        ...
        public async Task<ServiceResult<PageData<StockProductQuantityWarning>>> GetStockProductQuantityWarning([FromQuery] string keyword, [FromQuery] IList<int> stockIds, [FromQuery] IList<int> productTypeIds, [FromQuery] IList<int> productCateIds, [FromQuery] int page, [FromQuery] int size)
        {
        ...
        public async Task<ServiceResult<ServiceResult<StockProductDetailsReportOutput>>> StockProductDetailsReport([FromQuery] int productId, [FromQuery] IList<int> stockIds, [FromQuery] long fromDate, [FromQuery] long toDate)
        {
        ...
        public async Task<ServiceResult<PageData<StockSumaryReportForm04Output>>> StockSumaryReportForm04([FromQuery] IList<int> stockIds, [FromQuery] long fromDate, [FromQuery] long toDate, [FromQuery] int page, [FromQuery] int size)
        {
