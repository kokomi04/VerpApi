...
namespace VErpApi.Controllers.System
{
    ...
    public class ObjectGenCodeController : VErpBaseController
    {
        ...
        [HttpGet]
        [Route("")]
        public async Task<PageData<ObjectGenCodeOutputModel>> Get([FromQuery] EnumObjectType objectType, [FromQuery] string keyword, [FromQuery] int page, [FromQuery] int size)
        {
