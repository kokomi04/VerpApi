...
namespace VErpApi.Controllers.System
{
    ...
    public class UserActivityLogController : VErpBaseController
    {
        ...
        public UserActivityLogController(IUserLogActionService userLogActionService)
        {
        ...
        {
            return await _userLogActionService.GetListUserActivityLog(null, keyword, fromDate, toDate, userId, billTypeId, objectId, objectTypeId, actionTypeId, sortBy, asc, page, size);
        }
