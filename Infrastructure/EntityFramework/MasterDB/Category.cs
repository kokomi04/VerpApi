...
public partial class Category
{
    ...
    public virtual ICollection<CategoryField> CategoryField { get; set; } = new List<CategoryField>();

    public virtual CategoryGroup CategoryGroup { get; set; }

    public virtual ICollection<CategoryView> CategoryView { get; set; } = new List<CategoryView>();
}
