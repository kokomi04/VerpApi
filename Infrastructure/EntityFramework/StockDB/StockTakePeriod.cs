...
public partial class StockTakePeriod
{
    ...
    public virtual ICollection<StockTake> StockTake { get; set; } = new List<StockTake>();

    public virtual StockTakeAcceptanceCertificate StockTakeAcceptanceCertificate { get; set; }

    public virtual ICollection<StockTakeRepresentative> StockTakeRepresentative { get; set; } = new List<StockTakeRepresentative>();
}
