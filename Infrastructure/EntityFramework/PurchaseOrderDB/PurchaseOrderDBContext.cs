...
public partial class PurchaseOrderDBContext : DbContext
{
    ...
    public virtual DbSet<PurchasingSuggestDetailSubCalculation> PurchasingSuggestDetailSubCalculation { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CuttingExcessMaterialId).IsClustered(false);
            ...
            entity.Property(e => e.WorkpieceQuantity).HasColumnType("decimal(32, 12)");

            entity.HasOne(d => d.CuttingWorkSheet).WithMany(p => p.CuttingExcessMaterial)
        ...
        {
            entity.HasKey(e => e.CuttingWorkSheetId).HasName("PK__CuttingW__2ADFFCE19CDB8FE7");

            entity.Property(e => e.InputQuantity).HasColumnType("decimal(32, 12)");

            entity.HasOne(d => d.PropertyCalc).WithMany(p => p.CuttingWorkSheet)
        ...
        {
            entity.HasKey(e => new { e.CuttingWorkSheetId, e.ProductId }).HasName("PK__CuttingW__E19F308DFAD9852B");

            entity.Property(e => e.ProductQuantity).HasColumnType("decimal(32, 12)");
            entity.Property(e => e.WorkpieceQuantity).HasColumnType("decimal(32, 12)");

            entity.HasOne(d => d.CuttingWorkSheet).WithMany(p => p.CuttingWorkSheetDest)
                .HasForeignKey(d => d.CuttingWorkSheetId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<CuttingWorkSheetFile>(entity =>
        {
            ...
            entity.HasOne(d => d.CuttingWorkSheet).WithMany(p => p.CuttingWorkSheetFile)
                .HasForeignKey(d => d.CuttingWorkSheetId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasOne(d => d.ElectronicInvoiceProvider).WithMany(p => p.ElectronicInvoiceMapping)
        ...
        modelBuilder.Entity<MaterialCalcConsumptionGroup>(entity =>
        {
            ...
            entity.HasOne(d => d.MaterialCalc).WithMany(p => p.MaterialCalcConsumptionGroup)
        ...
        {
            entity.HasIndex(e => new { e.MaterialCalcId, e.ProductId }, "IX_MaterialCalcProduct_ProductId").IsUnique();

            entity.HasOne(d => d.MaterialCalc).WithMany(p => p.MaterialCalcProduct)
                .HasForeignKey(d => d.MaterialCalcId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.MaterialCalcProductId, e.ProductMaterialsConsumptionGroupId, e.MaterialProductId }).HasName("PK_MaterialCalcProductDetail_1");

            entity.Property(e => e.MaterialQuantity).HasColumnType("decimal(32, 12)");

            entity.HasOne(d => d.MaterialCalcProduct).WithMany(p => p.MaterialCalcProductDetail)
        ...
        modelBuilder.Entity<MaterialCalcProductOrder>(entity =>
        {
            ...
            entity.Property(e => e.OrderProductQuantity).HasColumnType("decimal(32, 12)");

            entity.HasOne(d => d.MaterialCalcProduct).WithMany(p => p.MaterialCalcProductOrder)
                .HasForeignKey(d => d.MaterialCalcProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<MaterialCalcSummary>(entity =>
        {
            ...
            entity.HasOne(d => d.MaterialCalc).WithMany(p => p.MaterialCalcSummary)
                .HasForeignKey(d => d.MaterialCalcId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<MaterialCalcSummarySubCalculation>(entity =>
        {
            ...
            entity.HasOne(d => d.MaterialCalcSummary).WithMany(p => p.MaterialCalcSummarySubCalculation)
        ...
        modelBuilder.Entity<PoAssignment>(entity =>
        {
            ...
            entity.HasOne(d => d.PurchasingSuggest).WithMany(p => p.PoAssignment)
        ...
        modelBuilder.Entity<PoAssignmentDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.PoAssignment).WithMany(p => p.PoAssignmentDetail)
                .HasForeignKey(d => d.PoAssignmentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PoAssignmentDetail_PoAssignment");

            entity.HasOne(d => d.PurchasingSuggestDetail).WithMany(p => p.PoAssignmentDetail)
        ...
        modelBuilder.Entity<PoProviderPricingDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.PoProviderPricing).WithMany(p => p.PoProviderPricingDetail)
        ...
        {
            entity.HasOne(d => d.PoProviderPricing).WithMany(p => p.PoProviderPricingFile)
                .HasForeignKey(d => d.PoProviderPricingId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasIndex(e => new { e.ProductPriceConfigVersionId, e.ItemKey }, "IX_ProductPriceConfigItem").IsUnique();
            ...
            entity.HasOne(d => d.ProductPriceConfigVersion).WithMany(p => p.ProductPriceConfigItem)
        ...
        modelBuilder.Entity<ProductPriceConfigItemPrice>(entity =>
        {
            ...
            entity.HasOne(d => d.ProductPriceConfig).WithMany(p => p.ProductPriceConfigItemPrice)
        ...
        modelBuilder.Entity<ProductPriceConfigVersion>(entity =>
        {
            ...
            entity.HasOne(d => d.ProductPriceConfig).WithMany(p => p.ProductPriceConfigVersion)
                .HasForeignKey(d => d.ProductPriceConfigId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.PropertyCalcId).HasName("PK__Property__609F42D972D80390");
        ...
        {
            entity.HasKey(e => e.PropertyCalcProductId).HasName("PK_MaterialCalcProduct_copy1");

            entity.HasIndex(e => new { e.PropertyCalcId, e.ProductId }, "IX_MaterialCalcProduct_ProductId_copy1").IsUnique();

            entity.HasOne(d => d.PropertyCalc).WithMany(p => p.PropertyCalcProduct)
                .HasForeignKey(d => d.PropertyCalcId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.PropertyCalcProductId, e.PropertyId, e.MaterialProductId }).HasName("PK_MaterialCalcProductDetail_1_copy1");

            entity.Property(e => e.MaterialQuantity).HasColumnType("decimal(32, 12)");

            entity.HasOne(d => d.PropertyCalcProduct).WithMany(p => p.PropertyCalcProductDetail)
        ...
        {
            entity.HasKey(e => new { e.PropertyCalcProductId, e.OrderCode }).HasName("PK_MaterialCalcProductOrder_copy1");

            entity.Property(e => e.OrderCode).HasMaxLength(128);
            entity.Property(e => e.OrderProductQuantity).HasColumnType("decimal(32, 12)");

            entity.HasOne(d => d.PropertyCalcProduct).WithMany(p => p.PropertyCalcProductOrder)
                .HasForeignKey(d => d.PropertyCalcProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.PropertyCalcId, e.PropertyId }).HasName("PK_MaterialCalcConsumptionGroup_copy1");

            entity.HasOne(d => d.PropertyCalc).WithMany(p => p.PropertyCalcProperty)
                .HasForeignKey(d => d.PropertyCalcId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.PropertyCalcSummaryId).HasName("PK_MaterialCalcSummary_copy1");
            ...
            entity.HasOne(d => d.PropertyCalc).WithMany(p => p.PropertyCalcSummary)
                .HasForeignKey(d => d.PropertyCalcId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<PurchaseOrderDetailSubCalculation>(entity =>
        {
            ...
            entity.HasOne(d => d.PurchaseOrderDetail).WithMany(p => p.PurchaseOrderDetailSubCalculation)
        ...
        modelBuilder.Entity<PurchaseOrderExcess>(entity =>
        {
            ...
            entity.HasOne(d => d.PurchaseOrder).WithMany(p => p.PurchaseOrderExcess)
                .HasForeignKey(d => d.PurchaseOrderId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<PurchaseOrderFile>(entity =>
        {
            ...
            entity.HasOne(d => d.PurchaseOrder).WithMany(p => p.PurchaseOrderFile)
                .HasForeignKey(d => d.PurchaseOrderId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<PurchaseOrderMaterials>(entity =>
        {
            ...
            entity.HasOne(d => d.PurchaseOrder).WithMany(p => p.PurchaseOrderMaterials)
                .HasForeignKey(d => d.PurchaseOrderId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<PurchaseOrderTracked>(entity =>
        {
            ...
            entity.HasOne(d => d.PurchaseOrder).WithMany(p => p.PurchaseOrderTracked)
                .HasForeignKey(d => d.PurchaseOrderId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<PurchasingRequest>(entity =>
        {
            ...
            entity.HasOne(d => d.MaterialCalc).WithMany(p => p.PurchasingRequest)
                .HasForeignKey(d => d.MaterialCalcId)
                .HasConstraintName("FK_PurchasingRequest_MaterialCalc");

            entity.HasOne(d => d.PropertyCalc).WithMany(p => p.PurchasingRequest)
                .HasForeignKey(d => d.PropertyCalcId)
        ...
        modelBuilder.Entity<PurchasingRequestDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.PurchasingRequest).WithMany(p => p.PurchasingRequestDetail)
        ...
        modelBuilder.Entity<PurchasingSuggestDetailSubCalculation>(entity =>
        {
            entity.Property(e => e.PrimaryQuantity).HasColumnType("decimal(32, 12)");
            entity.Property(e => e.PrimaryUnitPrice).HasColumnType("decimal(18, 5)");

            entity.HasOne(d => d.PurchasingSuggestDetail).WithMany(p => p.PurchasingSuggestDetailSubCalculation)
                .HasForeignKey(d => d.PurchasingSuggestDetailId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PurchasingSuggestDetailSubCalculation_PurchasingSuggestDetail");
        });
        ...
        modelBuilder.Entity<PurchasingSuggestFile>(entity =>
        {
            ...
            entity.HasOne(d => d.PurchasingSuggest).WithMany(p => p.PurchasingSuggestFile)
                .HasForeignKey(d => d.PurchasingSuggestId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<RefOutsourcePartRequest>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("RefOutsourcePartRequest");
        ...
        modelBuilder.Entity<RefOutsourceStepRequest>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("RefOutsourceStepRequest");
        ...
        {
            entity.HasKey(e => e.VoucherAreaId).HasName("PK_InputArea");
            ...
            entity.HasOne(d => d.VoucherType).WithMany(p => p.VoucherArea)
        ...
        {
            entity.HasKey(e => e.VoucherAreaFieldId).HasName("PK__InputAre__C2457D60A15F171E");

            entity.HasIndex(e => new { e.VoucherTypeId, e.VoucherFieldId }, "IX_InputAreaField").IsUnique();
            ...
            entity.HasOne(d => d.VoucherArea).WithMany(p => p.VoucherAreaField)
                .HasForeignKey(d => d.VoucherAreaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_VoucherAreaField_VoucherArea");

            entity.HasOne(d => d.VoucherField).WithMany(p => p.VoucherAreaField)
                .HasForeignKey(d => d.VoucherFieldId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_VoucherAreaField_VoucherField");

            entity.HasOne(d => d.VoucherType).WithMany(p => p.VoucherAreaField)
                .HasForeignKey(d => d.VoucherTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<VoucherBill>(entity =>
        {
            ...
            entity.HasOne(d => d.VoucherType).WithMany(p => p.VoucherBill)
                .HasForeignKey(d => d.VoucherTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.VoucherFieldId).HasName("PK_InputField");
        ...
        {
            entity.HasKey(e => e.VoucherTypeId).HasName("PK_InputType");
            ...
            entity.HasOne(d => d.VoucherTypeGroup).WithMany(p => p.VoucherType)
        ...
        {
            entity.HasKey(e => e.VoucherTypeGroupId).HasName("PK_InputTypeGroup");
        ...
        {
            entity.HasKey(e => e.VoucherTypeViewId).HasName("PK_InputTypeView");

            entity.Property(e => e.VoucherTypeViewName)
                .IsRequired()
                .HasMaxLength(128);

            entity.HasOne(d => d.VoucherType).WithMany(p => p.VoucherTypeView)
                .HasForeignKey(d => d.VoucherTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.VoucherTypeViewFieldId).HasName("PK_InputTypeViewField_1");
            ...
            entity.HasOne(d => d.VoucherTypeView).WithMany(p => p.VoucherTypeViewField)
