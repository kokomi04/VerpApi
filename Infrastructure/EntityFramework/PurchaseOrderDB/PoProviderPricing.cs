...
namespace VErp.Infrastructure.EF.PurchaseOrderDB
{
    ...
    {
        public PoProviderPricing()
        {
            PoProviderPricingDetail = new HashSet<PoProviderPricingDetail>();
            PoProviderPricingFile = new HashSet<PoProviderPricingFile>();
        }
        ...
        public virtual ICollection<PoProviderPricingDetail> PoProviderPricingDetail { get; set; }
        public virtual ICollection<PoProviderPricingFile> PoProviderPricingFile { get; set; }
    }
}
