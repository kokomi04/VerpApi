    ...
    public partial class AccountingDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Data>(entity =>
            {
                ...
                entity.Property(e => e.AddressMr)
                    .HasColumnName("Address_Mr")
                    .HasMaxLength(512);
                ...
                entity.Property(e => e.CreditAccountTax).HasColumnName("Credit_Account_TAX");

                entity.Property(e => e.Currency).HasMaxLength(512);

                entity.Property(e => e.CustomerCode)
                    .HasColumnName("Customer_Code")
                    .HasMaxLength(512);

                entity.Property(e => e.CustomerCodeDeb).HasColumnName("Customer_Code_Deb");

                entity.Property(e => e.CustomerName)
                    .HasColumnName("Customer_name")
                    .HasMaxLength(512);

                entity.Property(e => e.CustomerNameDeb).HasColumnName("Customer_Name_Deb");

                entity.Property(e => e.DebitAccount)
                    .HasColumnName("Debit_Account")
                    .HasMaxLength(512);

                entity.Property(e => e.DebitAccountTax)
                    .HasColumnName("Debit_Account_Tax")
                    .HasMaxLength(512);

                entity.Property(e => e.Dept).HasMaxLength(512);

                entity.Property(e => e.DescDetailed)
                    .HasColumnName("Desc_Detailed")
                    .HasMaxLength(512);

                entity.Property(e => e.Descriptions).HasMaxLength(512);

                entity.Property(e => e.DueAmountCurrency).HasColumnName("Due_Amount_Currency");

                entity.Property(e => e.DueAmountVnd).HasColumnName("Due_Amount_VND");

                entity.Property(e => e.ExRate).HasColumnName("Ex_Rate");

                entity.Property(e => e.ImExRate).HasColumnName("Im_Ex_Rate");

                entity.Property(e => e.ImExTax).HasColumnName("Im_Ex_Tax");
                ...
                entity.Property(e => e.InputTypeName).HasMaxLength(128);

                entity.Property(e => e.IssuingDate)
                    .HasColumnName("Issuing_Date")
                    .HasMaxLength(512);

                entity.Property(e => e.Items).HasMaxLength(512);

                entity.Property(e => e.ItemsCode).HasColumnName("Items_Code");
                ...
                entity.Property(e => e.ProductionPlant)
                    .HasColumnName("Production_Plant")
                    .HasMaxLength(512);

                entity.Property(e => e.QuantityOd).HasColumnName("Quantity_Od");

                entity.Property(e => e.QuantityPo).HasColumnName("Quantity_Po");

                entity.Property(e => e.QuantityReq).HasColumnName("Quantity_Req");

                entity.Property(e => e.ReceExpeItems)
                    .HasColumnName("Rece_Expe_Items")
                    .HasMaxLength(512);

                entity.Property(e => e.Remarks).HasMaxLength(512);

                entity.Property(e => e.Serial).HasMaxLength(512);

                entity.Property(e => e.StateTreasuryAcc).HasColumnName("State_Treasury_Acc");

                entity.Property(e => e.Stock).HasMaxLength(512);

                entity.Property(e => e.StockDeb).HasColumnName("Stock_Deb");
                ...
                entity.Property(e => e.TotalOfGoods).HasColumnName("Total_Of_Goods");

                entity.Property(e => e.TotalVatTax).HasColumnName("Total_VAT_Tax");

                entity.Property(e => e.Unit).HasMaxLength(512);

                entity.Property(e => e.UnitPrice).HasColumnName("Unit_Price");

                entity.Property(e => e.VatInvNo)
                    .HasColumnName("VAT_Inv_No")
                    .HasMaxLength(512);
                ...
                entity.Property(e => e.Work).HasMaxLength(512);
            });
