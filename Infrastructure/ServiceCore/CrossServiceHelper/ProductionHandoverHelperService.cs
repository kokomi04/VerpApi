...
namespace VErp.Infrastructure.ServiceCore.CrossServiceHelper
{
    ...
    {
        Task<bool> ChangeAssignedProgressStatus(string productionOrderCode, int[] departmentIds, DataTable inventories);
    ...
    public class ProductionHandoverHelperService : IProductionHandoverHelperService
    {
        ...
        public async Task<bool> ChangeAssignedProgressStatus(string productionOrderCode, int[] departmentIds, DataTable inventories)
        {
