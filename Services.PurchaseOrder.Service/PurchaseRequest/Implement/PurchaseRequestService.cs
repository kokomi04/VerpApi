...
namespace Services.PurchaseOrder.Service.PurchaseRequest.Implement
{
    class PurchaseRequestService : IPurchasingRequest
    {
        ...
        public PurchaseRequestService(MasterDBContext masterDBContext, StockDBContext stockContext, PurchaseOrderDBContext purchaseOrderDBContext
        ...
        public async Task<ServiceResult<long>> AddPurchasingRequest(int currentUserId, PurchasingRequestInputModel model)
        {
            using (var trans = await _purchaseOrderDBContext.Database.BeginTransactionAsync())
            {
                try
                {
                    var purchasingRequestObj = new PurchasingRequest()
                    {
