...
namespace VErp.Services.PurchaseOrder.Service.Voucher.Implement
{
    public class VoucherDataService : IVoucherDataService
    {
        ...
        public async Task<List<ValidateVoucherField>> GetVoucherFields(int voucherTypeId, int? areaId = null, int? viewOnly = null)
        {
        ...
        public async Task<CategoryNameModel> GetFieldDataForMapping(int voucherTypeId, int? areaId)
        {
            ...
            // Lấy thông tin field
            var fields = await GetVoucherFields(voucherTypeId, areaId, (int)EnumFormType.ViewOnly);
