...
namespace VErp.Services.PurchaseOrder.Service.Po
{
    public interface IPoProviderPricingService
    {
        ...
        Task<PageData<PoProviderPricingOutputList>> GetList(string keyword, IList<int> productIds, EnumPoProviderPricingStatus? purchaseOrderStatusId, EnumPoProcessStatus? poProcessStatusId, bool? isChecked, bool? isApproved, long? fromDate, long? toDate, string sortBy, bool asc, int page, int size);
