...
namespace VErp.Services.PurchaseOrder.Service
{
    public interface IPurchaseOrderOutsourcePartService
    {
        ...
        Task<IList<RefOutsourcePartRequestModel>> GetOutsourcePartRequest(long[] arrOutsourcePartId, string productionOrderCode, int? productId, bool ignoreOutsourceAllocateCompeleted = false);
